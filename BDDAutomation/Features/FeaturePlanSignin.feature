@Smoke
Feature: FeaturePlanSignin
	@FeaturePlanSigin
	Scenario Outline:Verify whether user sign In by Feature plan
	  ...
	  Examples: 
		 ...
		 | balachandrasekhar@jobiak.ai | bala@123  | https://app.jobiak.ai/login |




Scenario Outline:verify whether user click on "Add Job" and post Jobs by Feature plan with "Single Job"
	         Given user navigates to <url> Jobiak URL site
             When I Try to Signin with credentials <username> and <password>
 ...
 Scenario Outline:verify whether user click on "Add Job" and post Jobs by Feature plan with "Multiple Job"
            Given user navigates to <url> Jobiak URL site
            When I Try to Signin with credentials <username> and <password>
...
Scenario Outline: verify user upload "Job PDF" by Feature plan
            Given user navigates to <url> Jobiak URL site
