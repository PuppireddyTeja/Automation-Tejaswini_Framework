@Smoke
Feature: ProPlanSigin
	@ProPlanSigin
	Scenario Outline:Verify whether user sign by Pro plan
	  ...
	  Examples: 
		 ...
		 | venkatasai.nutheti+1052@jobiak.com | Sai@7596 | https://app.jobiak.ai/login |




Scenario Outline:verify whether user click on "Add Job" and post Jobs by Pro plan with "Single Job"
	         Given user navigates to <url> Jobiak URL site
             When I Try to Signin with credentials <username> and <password>
 ...
 Scenario Outline:verify whether user click on "Add Job" and post Jobs by Pro plan with "Multiple Job" url
            Given user navigates to <url> Jobiak URL site
            When I Try to Signin with credentials <username> and <password>
...
Scenario Outline: verify user upload "Job PDF" by Pro plan
            Given user navigates to <url> Jobiak URL site
